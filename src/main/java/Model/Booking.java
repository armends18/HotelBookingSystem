...
public class Booking implements Serializable {
    ...
    public void generateFirstInvoice(){
        ...
        System.out.println("You have booked Room "+room.getRoomNumber()+" of type: "+room.getType() +" for "+ (ChronoUnit.DAYS.between(guest.getDate1(),guest.getDate2())-1)+" nights.");
        System.out.println("The Dates of your stay are: "+guest.getDate1()+" "+guest.getDate2());
    ...
    public void generateCancellationInvoice(){
        ...
        System.out.println("The Dates of your stay were: "+guest.getDate1()+" "+guest.getDate2());
        System.out.println("Invoice Price: "+invoicePrice);
